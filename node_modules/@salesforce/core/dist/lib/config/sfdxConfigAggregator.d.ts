 ...
 * @hideconstructor
 */
export declare class SfdxConfigAggregator {
    /**
     ...
     */
    static create(): Promise<SfdxConfigAggregator>;
     ...
     * @returns {LOCATIONS}
     */
    getLocation(key: string): LOCATIONS;
    /**
     ...
     * @returns {SfdxConfig}
     */
    getLocalConfig(): SfdxConfig;
    /**
     * Get the global config instance.
     *
     * @returns {SfdxConfig}
     */
    getGlobalConfig(): SfdxConfig;
    /**
     ...
     */
    reload(): Promise<SfdxConfigAggregator>;
    /**
