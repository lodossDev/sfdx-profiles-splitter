...
class ConfigFile extends configStore_1.BaseConfigStore {
    ...
    static async resolveRootFolder(isGlobal) {
        if (!lodash_1.isBoolean(isGlobal)) {
    ...
    static async create(options) {
        ...
        const _isGlobal = lodash_1.isBoolean(config.options.isGlobal) && config.options.isGlobal;
        const _isState = lodash_1.isBoolean(config.options.isState) && config.options.isState;
