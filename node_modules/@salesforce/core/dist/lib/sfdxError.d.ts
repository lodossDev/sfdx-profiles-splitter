...
export declare class SfdxErrorConfig {
     ...
     */
    constructor(packageName: string, bundleName: string, errorKey: string, errorTokens?: Array<string | boolean | number>, actionKey?: string, actionTokens?: Array<string | boolean | number>);
    /**
     * Set the error key.
 ...
 *
 */
export declare class SfdxError extends Error {
    /**
     ...
     */
    static create(packageName: string, bundleName: string, key: string, tokens?: Array<string | boolean | number>): SfdxError;
    /**
     * Create a new SfdxError.
