...
class SfdxError extends Error {
    ...
    static create(packageNameOrErrorConfig, bundleName, key, tokens) {
        let errorConfig;
    ...
    format() {
        ...
        if (this.stack && global_1.Global.getEnvironmentMode() === global_1.Mode.DEVELOPMENT) {
            colorizedArgs.push(ux_1.color.red(`\n*** Internal Diagnostic ***\n\n${this.stack}\n******\n`));
        }
