...
export declare class Org {
     ...
     * @return {Promise<Org>}
     */
    static create(aliasOrUsername?: string, aggregator?: SfdxConfigAggregator, isDevHub?: boolean): Promise<Org>;
    /**
     ...
     * @return {Promise<Org>}
     */
    static create(connection?: Connection, aggregator?: SfdxConfigAggregator, isDevHub?: boolean): Promise<Org>;
    private logger;
    private connection;
    private status;
     ...
     */
    getConfigAggregator(): SfdxConfigAggregator;
    /**
