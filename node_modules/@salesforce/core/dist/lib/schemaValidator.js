...
class SchemaValidator {
    ...
    async load() {
        if (!this.schema) {
            this.schema = await json_1.readJsonMap(this.schemaPath);
    ...
    async loadExternalSchema(uri) {
        ...
        try {
            return await json_1.readJsonMap(schemaPath);
        }
        catch (err) {
            if (err.code === 'ENOENT') {
