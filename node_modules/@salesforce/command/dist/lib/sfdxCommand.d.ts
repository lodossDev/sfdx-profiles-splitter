...
import { Logger, UX, Org, SfdxConfigAggregator, Project, SfdxTableOptions, JsonMap, AnyJson } from '@salesforce/core';
import { SfdxFlagsConfig } from './sfdxFlags';
export interface SfdxResult {
    tableColumnData?: SfdxTableOptions;
    display?: () => void;
}
/**
